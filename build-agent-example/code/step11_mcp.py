#!/usr/bin/env python3
"""step11_mcp.py — 累积式 Agent：在 step10 Agent Team 基础上加入 MCP。"""
...
print("Step 11: 累积式 Agent（step10 + MCP）")
...
while True:
    ...
    while True:
        ...
        for block in other_blocks:
            ...
            elif block.name == "list_mcp_servers":
                results_map[block.id] = list_mcp_servers(block.input.get("server"))
